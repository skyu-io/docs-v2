...
Before you begin, ensure the `Infrastructure` feature is enabled for your project. If not, refer to the [Enable Infrastructure as Code](/docs/infrastructure/enable-feature) guide.
...
3. Click `Generate ARN` to create the role on AWS. You’ll be redirected to the AWS console. Fill in the required fields and click `Create Role`.
